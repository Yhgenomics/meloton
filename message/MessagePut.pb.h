...
// required string path = 1;
inline bool MessagePut::has_path() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void MessagePut::set_has_path() {
  _has_bits_[0] |= 0x00000001u;
}
inline void MessagePut::clear_has_path() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void MessagePut::clear_path() {
  if (path_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    path_->clear();
  }
  clear_has_path();
}
inline const ::std::string& MessagePut::path() const {
  // @@protoc_insertion_point(field_get:MessagePut.path)
  return *path_;
}
inline void MessagePut::set_path(const ::std::string& value) {
  set_has_path();
  if (path_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    path_ = new ::std::string;
  }
  path_->assign(value);
  // @@protoc_insertion_point(field_set:MessagePut.path)
}
inline void MessagePut::set_path(const char* value) {
  set_has_path();
  if (path_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    path_ = new ::std::string;
  }
  path_->assign(value);
  // @@protoc_insertion_point(field_set_char:MessagePut.path)
}
inline void MessagePut::set_path(const char* value, size_t size) {
  set_has_path();
  if (path_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    path_ = new ::std::string;
  }
  path_->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:MessagePut.path)
}
inline ::std::string* MessagePut::mutable_path() {
  set_has_path();
  if (path_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    path_ = new ::std::string;
  }
  // @@protoc_insertion_point(field_mutable:MessagePut.path)
  return path_;
}
inline ::std::string* MessagePut::release_path() {
  clear_has_path();
  if (path_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    return NULL;
  } else {
...
inline void MessagePut::set_allocated_path(::std::string* path) {
  if (path_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    delete path_;
  }
  if (path) {
  ...
  // @@protoc_insertion_point(field_set_allocated:MessagePut.path)
}
